/**
 * Contains the MyWebView class, which represents a standard browser widget.
 */
declare module "my-web-view" {
    import view = require("ui/core/view");
    import dependencyObservable = require("ui/core/dependency-observable");
    import observable = require("data/observable");

    /**
     * Represents a standard MyWebView widget.
     */
    export class MyWebView extends view.View {
        /**
        ...
        /**
         * Represents the observable property backing the Url property of each MyWebView instance.
         */
